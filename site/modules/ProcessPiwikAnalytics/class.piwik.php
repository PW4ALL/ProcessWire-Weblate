...
class Piwik {
	 ...
	 * @param string $columns
	 */
	public function getKeywords($segment = '', $columns = '', $filterlimit = '') {
	 ...
	 * @param string $segment
	 */
	public function getCountry($segment = '',$columns = '') {
   ...
   * @param string $segment
   */
  public function getCity($segment = '',$columns = '') {
    return $this->_request('UserCountry.getCity', array(
      'segment' => $segment,
      'columns' => $columns,
    ));
  ...
  /*
   * Get languages of all visitors
   *
   * @param string $segment
   */
  public function getUsersLanguage($segment = '') {
