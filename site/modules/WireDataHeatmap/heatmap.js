...
(function(w){
    ...
    legend.prototype = {
        init: function(){
            ...
            element.innerHTML = "<h3 style='padding:0 0 3px 0;margin:0 0 10px 0;border-bottom:1px solid gray;text-align:center;font-size:16px;'>"+title+"<br /></h3>";
            // create gradient in canvas
            labelsEl.style.cssText = "display:none";
